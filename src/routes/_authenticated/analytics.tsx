...
export const Route = createFileRoute("/_authenticated/analytics")({
  head: () => ({ meta: [{ title: "Analytics — coretex" }, { name: "description", content: "Visualize study minutes, subject mastery, and weekly progress trends." }, { name: "robots", content: "noindex,nofollow" }] }),
