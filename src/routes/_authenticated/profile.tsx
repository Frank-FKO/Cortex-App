...
export const Route = createFileRoute("/_authenticated/profile")({
  head: () => ({ meta: [{ title: "Profile — Coretex AI" }, { name: "description", content: "Update your display name, school level, and learning preferences." }, { name: "robots", content: "noindex,nofollow" }] }),
...
function ProfilePage() {
  ...
  return (
    <PageContainer>
      <PageHeader title="Profile" subtitle="How Coretex AI knows you." />
