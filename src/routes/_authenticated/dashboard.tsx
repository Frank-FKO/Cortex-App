...
export const Route = createFileRoute("/_authenticated/dashboard")({
  head: () => ({ meta: [{ title: "Dashboard — Cortex" }, { name: "description", content: "Your daily learning hub: XP, streaks, AI tutor, and next lessons." }, { name: "robots", content: "noindex,nofollow" }] }),
  component: Dashboard,
});
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          <div className="rounded-3xl bg-gradient-primary p-8 text-primary-foreground relative overflow-hidden shadow-soft">
            ...
            <h2 className="font-display text-2xl font-bold mb-2">Ask Cortex anything</h2>
