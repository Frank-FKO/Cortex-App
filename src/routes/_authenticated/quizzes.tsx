...
export const Route = createFileRoute("/_authenticated/quizzes")({
  head: () => ({ meta: [{ title: "Quizzes — Coretex AI" }, { name: "description", content: "Generate AI quizzes on any topic and review past attempts." }, { name: "robots", content: "noindex,nofollow" }] }),
...
function QuizzesPage() {
  ...
  return (
    <PageContainer>
      <PageHeader
        title="Quizzes"
        subtitle="Tell Coretex AI what you want to be tested on — get a tailored quiz in seconds."
        action={
          phase !== "setup" ? (
            <button
              onClick={reset}
          ...
          <div className="flex items-start gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Enter a topic, pick difficulty, and Coretex AI will craft questions for you.
              </p>
            </div>
          </div>
