...
export const Route = createFileRoute("/_authenticated/subjects")({
  head: () => ({ meta: [{ title: "Subjects — Coretex AI" }, { name: "description", content: "Browse subjects and track your mastery across the Coretex AI catalog." }, { name: "robots", content: "noindex,nofollow" }] }),
...
function SubjectsPage() {
  ...
  return (
    <PageContainer>
      <PageHeader
        title="Subjects"
        subtitle="Pick a subject to start learning. Coretex AI adapts to your level automatically."
      />
