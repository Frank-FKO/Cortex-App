...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Coretex AI — AI Learning Companion" },
      { name: "twitter:title", content: "Coretex AI — AI Learning Companion" },
      { property: "og:description", content: "Coretex AI is an AI-powered personalized learning platform that adapts to every student's pace and learning style." },
