...
export const chatWithTutor = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data }) => {
    ...
    const systemPrompt = {
      ...
      content:
        "You are Coretex AI, a friendly adaptive AI tutor for students. Explain concepts clearly with examples, use markdown, ask follow-up questions, and adapt to the learner's level.",
    };
